...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        C, H, W = input_dim
        # Size of the output of the first conv layer after pooling
        H1 = 1 + (H - 2) // 2
        W1 = 1 + (W - 2) // 2
    ...
    def loss(self, X, y=None):
        ...
        hidden_dx, grads['W3'], grads['b3'] = affine_backward(dscores, scores_cache)
        conv_dx, grads['W2'], grads['b2'] = affine_relu_backward(hidden_dx, hidden_cache)
        _, grads['W1'], grads['b1'] = conv_relu_pool_backward(conv_dx, conv_cache)
